...
get_filename_component(_filename "/home/polimi/robotics/src/service/service/srv/AddTwoInts.srv" NAME_WE)
add_custom_target(_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "service" "/home/polimi/robotics/src/service/service/srv/AddTwoInts.srv" ""
)
...
_generate_srv_cpp(service
  "/home/polimi/robotics/src/service/service/srv/AddTwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service\")")
  # install generated code
  install(
